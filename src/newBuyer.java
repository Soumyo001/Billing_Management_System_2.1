...
public class newBuyer extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(230, 20, 270, -1));
        ...
        getContentPane().add(jSeparator1, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 91, 570, -1));
        ...
        getContentPane().add(jTextField1, new org.netbeans.lib.awtextra.AbsoluteConstraints(260, 130, 299, -1));
        ...
        getContentPane().add(jTextField2, new org.netbeans.lib.awtextra.AbsoluteConstraints(260, 170, 299, -1));
        ...
        getContentPane().add(jTextField3, new org.netbeans.lib.awtextra.AbsoluteConstraints(260, 220, 299, -1));
        ...
        getContentPane().add(jTextField4, new org.netbeans.lib.awtextra.AbsoluteConstraints(260, 270, 299, -1));

        jComboBox1.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "male", "female", "others" }));
        getContentPane().add(jComboBox1, new org.netbeans.lib.awtextra.AbsoluteConstraints(260, 310, 299, -1));
        getContentPane().add(jSeparator2, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 370, 570, 10));
    ...
    private void jTextField4FocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_jTextField4FocusLost
        if(jTextField4.getText().equals("")){
            jTextField4.setText("Enter Address");
            jTextField4.setForeground(new Color(155,155,155));
        }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try{
           ...
           ResultSet rs=st.executeQuery("select*from employee where contactNo='"+number+"'");
           if(rs.next()) throw new billing_management_system.sameDataException();
           if(name.equals("Enter Name")||number.equals("Enter Contact No")||mail.equals("Enter Email")||address.equals("Enter Address")||gender.equals(null)) throw new billing_management_system.emptyFieldException();
           if(!(mail.contains("@gmail.com")||mail.contains("@hotmail.com")||mail.contains("@yahoo.com")||mail.contains("@outlook.com"))) throw new billing_management_system.emailException();
           st.executeUpdate("insert into buyer values('"+name+"','"+number+"','"+mail+"','"+address+"','"+gender+"')");
...
//create table register(name varchar(100),mobileNo varchar(12)primary key,email varchar(100),username varchar(100),password varchar(20));